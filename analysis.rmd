...
# Support Vector Machine (Vanilla Kernel)
```{r}
library(kernlab)
library(caret)
...
confusionMatrix(as.factor(rank_predictions_vanilla), as.factor(y_val))

```
## Vanilla SVM Stats

Accuracy: `r round(confusionMatrix(rank_predictions_vanilla, y_val)$overall[["Accuracy"]] * 100, 2)`%

Kappa: `r round(confusionMatrix(rank_predictions_vanilla, y_val)$overall[["Kappa"]] * 100, 2)`%